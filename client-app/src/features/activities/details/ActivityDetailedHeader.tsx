    ...
    return (
        <Segment.Group>
            ...
            <Segment clearing attached='bottom'>
                {activity.isHost ? (
                    <>
                        <Button onClick={cancelActivityToggle} basic color={activity.isCanceled ? 'green' : 'red'} floated='left' loading={loading} content={activity.isCanceled ? 'Re-Activate' : 'Cancel Activity'}/>
